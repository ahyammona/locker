...
contract thelunchbox is Ownable, ReentrancyGuard {
    ...
    uint256 public bnbFee = 1 ether / 2;
    // base 1000, 0.5% = value * 5 / 1000
    uint256 public lpFeePercent = 5;
    address payable devaddr = payable(0xbB81e9682f196633736ec9201f4071Fe908f3Be9); 
    ...
    function lockTokens(
        ...
        require(IBEP20(_tokenAddress).allowance(msg.sender,address(this)) >= _amount, 'please approve before calling lock Function');
        ...
        if (_feeInBnb) {
            ...
            TransferHelper.safeTransfer(_tokenAddress, devaddr, fee);
